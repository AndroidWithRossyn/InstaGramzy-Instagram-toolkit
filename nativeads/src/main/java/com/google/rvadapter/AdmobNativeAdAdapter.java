...
public class AdmobNativeAdAdapter extends RecyclerViewAdapterWrapper {
    ...
    private void onBindAdViewHolder(final RecyclerView.ViewHolder holder) {
        ...
        if (!adHolder.loaded){
            AdView adView = new AdView(adHolder.getContext());
            AdRequest adRequest = new AdRequest.Builder().build();
            adView.setAdSize(AdSize.MEDIUM_RECTANGLE);
            adView.setAdUnitId(adHolder.getContext().getString(R.string.admob_banner_medium_id));
    ...
    private AdSize getAdSize(Context context,LinearLayout layout) {
        ...
        float adWidthPixels = layout.getWidth();
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        Log.e("onBindViewHolder","trueeeeeeeeeeeeee");
    ...
    /*    AdView adView = new AdView(inflater.getContext());
        AdRequest adRequest = new AdRequest.Builder().build();
        adView.setAdSize(AdSize.BANNER);
        adView.setAdUnitId(inflater.getContext().getString(R.string.admob_banner_id));
        adView.loadAd(adRequest);*/
        LinearLayout adLayoutContent = (LinearLayout) inflater.inflate(R.layout.adaptive_banner, parent, false);
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        Log.e("onCreateViewholder","trueeeeeeeeeeeeee");
