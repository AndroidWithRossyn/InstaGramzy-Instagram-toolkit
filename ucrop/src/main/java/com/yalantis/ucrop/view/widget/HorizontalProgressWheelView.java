...
public class HorizontalProgressWheelView extends View {
    ...
    public void onDraw(Canvas canvas) {
        ...
        float f3 = centerY;
        canvas2.drawLine(centerX, f3, (float) this.mCanvasClipBounds.centerX(), (((float) this.mProgressLineHeight) / 2.0f) + ((float) this.mCanvasClipBounds.centerY()), this.mProgressMiddleLinePaint);
    }
