...
public class CropImageView extends TransformImageView {
    ...
    public void onImageLaidOut() {
        ...
        if (drawable != null) {
            ...
            if (i2 > i3) {
                ...
                int i4 = (int) (f2 * f3);
                int i5 = (i - i4) / 2;
                this.mCropRect.set((float) i5, 0.0f, (float) (i4 + i5), f3);
            } else {
                int i6 = (i3 - i2) / 2;
                this.mCropRect.set(0.0f, (float) i6, f, (float) (i2 + i6));
            }
            ...
            if (cropBoundsChangeListener != null) {
                cropBoundsChangeListener.onCropAspectRatioChanged(this.mTargetAspectRatio, 3, 1);
            }
    ...
    public void setTargetAspectRatio(float f, int i, int i2) {
        ...
        CropBoundsChangeListener cropBoundsChangeListener = this.mCropBoundsChangeListener;
        if (cropBoundsChangeListener != null) {
            cropBoundsChangeListener.onCropAspectRatioChanged(f, i, i2);
        }
    }
