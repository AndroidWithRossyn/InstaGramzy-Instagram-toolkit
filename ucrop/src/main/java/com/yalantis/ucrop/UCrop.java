...
public class UCrop {
    ...
    public static final String EXTRA_OUTPUT_OFFSET_COLUMN_COUNT = "com.yalantis.ucrop.ColumnCount";
    public static final String EXTRA_OUTPUT_OFFSET_ROW_COUNT = "com.yalantis.ucrop.RowCount";
    ...
    public static int getOutputColumnCount(Intent intent) {
        return intent.getIntExtra(EXTRA_OUTPUT_OFFSET_COLUMN_COUNT, -1);
    }
    ...
    public static int getOutputRowCount(Intent intent) {
        return intent.getIntExtra(EXTRA_OUTPUT_OFFSET_ROW_COUNT, -1);
    }
