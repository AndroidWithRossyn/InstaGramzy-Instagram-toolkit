...
public class TMSpannedGridLayoutManager extends RecyclerView.LayoutManager {
    ...
    public TMSpannedGridLayoutManager(GridSpanLookup spanLookup, int columns, float cellAspectRatio) {
    ...
    public TMSpannedGridLayoutManager(
